...
<html lang="en">
  ...
  <div class="wrapper">
        ...
        <form action="Singup.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-field d-flex align-items-center">
                <span class="fas fa-key"></span>
                <input type="text" name="confirm_pass" id="pwd" placeholder="Confirmer Mot de Passe">
            </div>
            <button class="btn mt-3" type="submit" name="submit">Sing Up</button>
        </form>
        <div class="text-center fs-6">
            <a href="#">Vous avez déjà un compte ?</a>  <a href="Login.php">Connexion</a>
        </div>
    </div>
</body>
<script>
