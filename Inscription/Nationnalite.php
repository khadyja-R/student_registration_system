<select class="form-control form-control-lg"  name="nationality">
    ...
    <option value="ATG">Antiguaise-et-Barbudienne (Antigua-et-Barbuda)
    </option>
    ...
    <option value="KNA">Kittitienne et Névicienne
    ...
    <option value="PNG">Papouane-Néo-Guinéenne (Papouasie-Nouvelle-Guinée)
    </option>
    ...
    <option value="VCT">Saint-Vincentaise et Grenadine (Saint-Vincent-et-les
        Grenadines)</option>
